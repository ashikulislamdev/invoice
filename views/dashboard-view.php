...
<div class="col-md-6 col-xl-3">
        <div class="card bg-c-blue order-card">
            <div class="card-block">
                ...
                <h2 class="text-right"><i class="ti-shopping-cart f-left"></i><span><?php echo $all_incomes; ?></span></h2>
                <p class="m-b-0">This Month<span class="f-right"><?php echo $totalLastMonthIncome; ?></span></p>
            </div>
        </div>
    </div>
    <div class="col-md-6 col-xl-3">
        <div class="card bg-c-green order-card">
            <div class="card-block">
                ...
                <h2 class="text-right"><i class="ti-tag f-left"></i><span><?php echo $getSumCost; ?></span></h2>
                <p class="m-b-0">This Month<span class="f-right"><?php echo $getLastMonthCost; ?></span></p>
            </div>
        </div>
    </div>
    <!-- <div class="col-md-6 col-xl-3">
    ...
    <div class="col-md-6 col-xl-3">
        <div class="card bg-c-pink order-card">
            <div class="card-block">
                ...
                <h2 class="text-right"><i class="ti-wallet f-left"></i><span><?php echo $all_incomes - $getSumCost; ?></span></h2>
